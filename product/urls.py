...
urlpatterns = [
    ...
    path('add_cart_sales/<int:pk>',views.add_cart_sales,name='add_cart_sales'),
    ...
    path('create_requisition/',views.create_req,name='create_req'),
    path('edit_requisition/<int:pk>/',views.edit_req,name='edit_req'),
    ...
    path('create_company_warehouse/',views.create_company_warehouse,name='create_company_warehouse'),
...
#    path('warehouse_stock/',views.warehouse_stock,name='warehouse_stock'),
    ...
    path('warehouse_stock/',views.stock_warehouse,name='warehouse_stock'),
    path('stock/<int:pk>/',views.stock,name='stock'),
    path('chat/',views.chat,name='chat'),
    path('charge/<int:pk>/',views.charge_payment,name='charge'),
    path('select_payment/<int:pk>/',views.select_payment,name='select_payment'),
