...
urlpatterns = [
    ...
    path('register_purchase/' , views.register_purchasing , name='register_purchase'),
    ...
    path('warehouse/',views.warehouse_list,name='all_warehouse_manager'),
    path('purchasing/',views.purchasing_list,name='all_purchasing'),
    path('soppliers/',views.supplier_list,name='all_suppliers'),
